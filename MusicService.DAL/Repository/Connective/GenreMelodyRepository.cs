...
{
    public class GenreMelodyRepository(ApplicationDbContext _context,
                                       IMapper _mapper) : IGenreMelody
    {
        ...
        public async Task<ResponseDTO> CreateConnectionAsync(ConnectFromToDTO connect)
        {
            ...
            var connective = _mapper.Map<GenreMelody>(connect);
            ...
            _context.GenreMelodies.Add(connective);
        ...
        {
            var connective = _context.GenreMelodies.Find(Id);
            ...
            _context.GenreMelodies.Remove(connective);
