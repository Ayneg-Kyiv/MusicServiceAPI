...
{
    public class AlbumMelodyRepository(ApplicationDbContext _context,
                                       IMapper _mapper) : IAlbumMelody
    {
        ...
        public async Task<ResponseDTO> CreateConnectionAsync(ConnectFromToDTO connect)
        {
            ...
            var connective = _mapper.Map<AlbumMelody>(connect);
            ...
            _context.AlbumMelodies.Add(connective);
        ...
        {
            var connective = _context.AlbumMelodies.Find(Id);
            ...
            _context.AlbumMelodies.Remove(connective);
